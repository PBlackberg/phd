...
def get_ds_highlight(switch_highlight, datasets, switch_subset= {'threshold_res':False}, func = exclude_models):
...
# ------------------------------------------------------------------------- pick out subset ----------------------------------------------------------------------------------------------------- #
datasets = constructed_fields + models_cmip5 + models_cmip6 + observations
...
# ----------------------------------------------------------------------------------- models excluded due to missing data ----------------------------------------------------------------------------------------------------- #
