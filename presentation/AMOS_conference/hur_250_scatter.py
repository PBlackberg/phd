...
def calc_hur_mean(experiment = ''):
    ...
    for dataset in mV.datasets:
        ...
        ds[dataset] = mD.load_metric_file('hur', 'hur_250hpa_sMean', dataset, experiment_alt).mean(dim='time').compute()
    return ds
...
if __name__ == '__main__':
    ...
    if plot:
        ...
        mFp.show_plot(fig, show_type = 'save_cwd', filename = f'rome_hur_vMean_difference.png')
        print('plotted rome hur_vMean difference')
        ...
        if plot: 
            ...
            mFp.show_plot(fig, show_type = 'save_cwd', filename = f'rome_hur_vMean_closeObs_difference.png')
