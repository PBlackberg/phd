...
def load_rlut_data(switch, source, dataset, experiment):
...
def run_experiment(switch, source, dataset):
    for experiment in mV.experiments:
        ...
        da = load_rlut_data(switch, source, dataset, experiment)
...
def run_rlut_metrics(switch):
    print(f'Running lw:rlut metrics with {mV.resolutions[0]} {mV.timescales[0]} data')
