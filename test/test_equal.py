...
a = xr.open_dataset('/Users/cbla0002/Documents/data/metrics/org/rome_95thprctile/cmip6/TaiESM1_rome_95thprctile_daily_historical_regridded.nc')['rome_95thprctile']
# print(a)

b = xr.open_dataset('/Users/cbla0002/Desktop/rome_95thprctile/TaiESM1_rome_95thprctile_daily_historical_regridded.nc')['rome_95thprctile']
# print(b)

data_equal = a.equals(b)

# data_equal = np.array_equal(a, b)
print(data_equal)
